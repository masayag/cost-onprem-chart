...
#   S3_CLI_IMAGE    - Container image with AWS CLI for bucket creation (default: amazon/aws-cli:2)
#
# Examples:
...
#   S3_CLI_IMAGE             - Container image with AWS CLI (default: amazon/aws-cli:2)
create_s3_buckets() {
    ...
    local bucket_image="${S3_CLI_IMAGE:-amazon/aws-cli:2}"
    local output
